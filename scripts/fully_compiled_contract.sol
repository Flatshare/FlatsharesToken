...
/*
 * FlatsharesToken is a standard ERC20 token with some additional functionalities:
...
contract FlatsharesToken is StandardToken, BurnableToken, Ownable {
    string public constant symbol = "BEE";
    string public constant name = "Flatshares Token";
     ...
     */
    function FlatsharesToken(address admin) public {
