...
contract FlatsharesPayments is Ownable { 
    ...
    function FlatsharesPayments(address arbitrationAddress_, uint256 arbitrationFee_) public {
    ...
    returns(bool success)
    {
        // TODO: pass escrow to Flatshares Arbitration protocol
